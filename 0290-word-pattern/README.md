<h2><a href="https://leetcode.cn/problems/word-pattern/">290. 单词规律</a></h2><h3>Easy</h3><hr><p>给定一种规律 <code>pattern</code>&nbsp;和一个字符串&nbsp;<code>s</code>&nbsp;，判断 <code>s</code>&nbsp;是否遵循相同的规律。</p>
